      ...
      <div style={{ maxWidth: 'var(--container-max-width, 1200px)', margin: '0 auto', width: '100%' }}>
        ...
        <ul className="contact-details">
          ...
          <li>
            ...
            <a 
              href="https://wa.me/8801941273428" 
              target="_blank" 
        ...
        <div className="social-links">
          <a href="https://www.facebook.com/rahat.hasan.907270/" target="_blank" rel="noopener noreferrer">
            <FaFacebook />
          </a>

          <a href="https://www.instagram.com/laden__b/" target="_blank" rel="noopener noreferrer">
            <FaInstagram />
          </a>

          <a href="https://github.com/Rahat6363/" target="_blank" rel="noopener noreferrer">
            <FaGithub />
          </a>
